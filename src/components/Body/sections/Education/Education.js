          ...
          <div className='md:bg-cyan-800 py-12 md:px-44'>
              ...
              <div className='flex py-4 flex-col md:flex-row mt-6 space-y-6 md:space-y-0 md:space-x-6 space-x-0 justify-center items-center '>
                  <div className='relative w-9/12 md:w-1/3'>
                      ...
                      <div className='relative card m-2 p-6 bg-white md:h-auto rounded-xl shadow-2xl'>
                            <img src={svceLogo} className='md:w-32 w-48 mb-6 md:mb-4 m-auto md:h-32'/>
                            <div className='text-cyan-800 text-xl font-bold text-center'>
                                Sri Venkateswara College of Engineering    
                            </div>
                            <div className='text-cyan-800 font-bold text-center'>
                  ...
                  <div className='relative w-9/12 md:w-1/3'>
                      ...
                      <div className='relative card p-6 m-2 z-10 bg-white md:h-auto rounded-md shadow-2xl'>
