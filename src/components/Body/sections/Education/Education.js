...
const Education = () => {
  return (
      <div id="education" className='min-h-screen'>
          <div className='md:pt-20 py-12 md:px-44'>
              <h2 className='text-center text-4xl md:text-6xl py-3 w-1/2 m-auto bg-white uppercase font-bold md:tracking-wide'>Education</h2>
              <div className='flex py-4 flex-col md:flex-row mt-6 space-y-6 md:space-y-0 md:space-x-6 space-x-0 justify-center items-center md:pt-40'>
                  <div className='relative w-9/12 md:w-1/3 '>
                      ...
                      <div className='relative card m-2 px-6 py-10 bg-gray-800 md:h-auto rounded-xl shadow-2xl text-white hover:rotate-12 duration-500 delay-75'>
                  ...
                  <div className='relative w-9/12 md:w-1/3'>
                      ...
                      <div className='relative card px-6 py-10 m-2 z-10 bg-gray-800 md:h-auto rounded-md shadow-2xl text-white hover:rotate-12 duration-500 delay-75'>
